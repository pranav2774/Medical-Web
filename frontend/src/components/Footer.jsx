    ...
    return (
        <footer className="bg-gray-950 text-gray-400 mt-auto relative overflow-hidden">
            ...
            <div className="absolute inset-0" style={{ zIndex: 0 }}>
                <MolecularBackground color="20, 184, 166" />
            </div>
            {/* Top accent bar */}
            <div className="h-1 bg-gradient-to-r from-primary-600 via-primary-400 to-primary-500 relative z-10"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
                    ...
                    <div className="md:col-span-5">
                        ...
                        <div className="flex gap-3 mt-5">
                            <a href="#" className="p-2 rounded-sm bg-gray-800 hover:bg-gray-700 text-gray-400 hover:text-white transition-colors">
                    ...
                    <div className="md:col-span-2">
                        <h3 className="text-xs font-semibold text-gray-300 tracking-widest uppercase mb-4">Quick Links</h3>
                        <ul className="space-y-2.5">
                            <li><Link to="/" className="text-sm text-gray-400 hover:text-white transition-colors">Home</Link></li>
                            <li><Link to="/store" className="text-sm text-gray-400 hover:text-white transition-colors">Catalog</Link></li>
                            <li><Link to="/cart" className="text-sm text-gray-400 hover:text-white transition-colors">My Cart</Link></li>
                            <li><Link to="/my-orders" className="text-sm text-gray-400 hover:text-white transition-colors">Order History</Link></li>
