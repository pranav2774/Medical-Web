...
export default function ExpenseAnalytics() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      <AdminNavbar pageTitle="Expense Analytics" />
          ...
          <>
            ...
            {kpiData && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {/* Total Expenses */}
                <div className="bg-white p-6 border-y border-r border-l-4 border-y-gray-200 border-r-gray-200 border-l-primary-500 rounded-sm shadow-sm">
                  ...
                  <p className={`text-sm ${(kpiData.monthOverMonthChange || 0) >= 0 ? 'text-red-600' : 'text-green-600'
                    }`}>
                ...
                {/* Top Vendor */}
                <div className="bg-white p-6 border-y border-r border-l-4 border-y-gray-200 border-r-gray-200 border-l-purple-500 rounded-sm shadow-sm">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                ...
                {/* Top Category */}
                <div className="bg-white p-6 border-y border-r border-l-4 border-y-gray-200 border-r-gray-200 border-l-green-500 rounded-sm shadow-sm">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                ...
                {/* Budget Status */}
                <div className="bg-white p-6 border-y border-r border-l-4 border-y-gray-200 border-r-gray-200 border-l-orange-500 rounded-sm shadow-sm">
                  <div className="flex justify-between items-start mb-4">
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 border border-gray-200 rounded-sm shadow-sm">
                <h2 className="text-lg font-bold text-gray-900 tracking-tight mb-6">Monthly Trend (Last {filters.months} Months)</h2>
              ...
              {/* Category Breakdown */}
              <div className="bg-white p-6 border border-gray-200 rounded-sm shadow-sm">
                <h2 className="text-lg font-bold text-gray-900 tracking-tight mb-6">Category Breakdown</h2>
              ...
              {/* Budget vs Actual */}
              <div className="bg-white p-6 border border-gray-200 rounded-sm shadow-sm lg:col-span-2">
                <h2 className="text-lg font-bold text-gray-900 tracking-tight mb-4">Budget vs Actual Spending</h2>
                    ...
                    {budgetVsActual.map((item, index) => (
                      <div key={index} className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="mt-2 pt-2 border-t border-gray-200">
                          <span className={`text-xs font-semibold ${item.actual > item.budget ? 'text-red-600' : 'text-green-600'
                            }`}>
